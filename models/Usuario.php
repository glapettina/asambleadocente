<?php
  ...
  /*   TODO: Definición de la clase Usuario que extiende la clase Conectar */
    ...
    class Usuario extends Conectar{
        ...
        /* TODO: Método para registra un nuevo usuario en la base de datos */
       ...
       /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
        ...
        $sql="UPDATE tm_usuario SET est = 1, fech_acti = NOW() WHERE usu_id = ?";
      ...
      public function login_colaborador(){
        ...
        /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
          ...
          /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
            ...
            $sql="SELECT tm_usuario.usu_id, tm_usuario.usu_nomape, tm_usuario.usu_correo, tm_usuario.rol_id,
                  tm_rol.rol_nom,
                  tm_usuario.fech_crea
                  FROM tm_usuario 
                 INNER JOIN tm_rol ON tm_usuario.rol_id = tm_rol.rol_id WHERE tm_usuario.est = 1 AND tm_usuario.rol_id IN (2,3)";
        ...
        public function update_colaborador($usu_id, $usu_nomape, $usu_correo, $rol_id){
         ...
         /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
          ...
          $sql="UPDATE tm_usuario SET usu_nomape = ?, usu_correo = ?, rol_id = ?, fech_modi = NOW() WHERE usu_id = ?";
