<?php
    ...
    class Exactas extends Conectar{

        public function get_exactas(){
           ...
           /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
            ...
            WHERE tm_vacante.estado = 1 AND tm_vacante.area_id = 6";
        ...
        public function get_exactas_mini(){
           ...
           /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
            ...
            WHERE tm_vacantemini.estado = 1 AND tm_vacantemini.area_id = 6";
