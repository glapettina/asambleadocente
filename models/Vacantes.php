<?php
    ...
    class Vacantes extends Conectar{
        ...
        public function get_vacantes_mini(){
        ...
        public function insert_vacante_mini($area_id, $esc_id, $codigo, $asignatura, $id, $horas, $turno, $origen){
           ...
           /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
            ...
            $sql="INSERT INTO tm_vacantemini (area_id, esc_id, codigo, asignatura, id, horas, turno, 
            origen) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        public function update_vacante_mini($vacante_id, $esc_id, $codigo, $asignatura, $id, $horas, $turno, $origen){
           ...
           /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
            ...
            $sql="UPDATE tm_vacantemini SET esc_id = ?, codigo = ?, asignatura = ?, id = ?, horas = ?, turno =?, origen = ? fech_modi = NOW() WHERE vacante_id = ?";
        ...
        public function get_vacante_id($esc_id, $id){
           ...
           /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
            ...
            $sql="SELECT * FROM tm_vacante WHERE esc_id = ? AND id = ?";
       ...
       public function get_vacante_id_mini($esc_id, $id){
       ...
       /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
        ...
        $sql="SELECT * FROM tm_vacantemini WHERE esc_id = ? AND id = ?";
       ...
       /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
        ...
        return $sql->fetchAll();
          ...
          public function get_vacante_x_id_mini($vacante_id){
           ...
           /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
            ...
            $sql="SELECT * FROM tm_vacantemini WHERE vacante_id = ?";
   ...
   /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
    ...
    public function eliminar_vacante_mini($vacante_id){
       ...
       /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
        ...
        $sql="UPDATE tm_vacantemini SET estado = 0, fech_elim = NOW() WHERE vacante_id = ?";
