<?php
    ...
    class Contables extends Conectar{

        public function get_contables(){
           ...
           /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
            ...
            WHERE tm_vacante.estado = 1 AND tm_vacante.area_id = 4";
        ...
        public function get_contables_mini(){
           ...
           /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
            ...
            WHERE tm_vacantemini.estado = 1 AND tm_vacantemini.area_id = 4";
