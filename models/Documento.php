<?php
  ...
  /*   TODO: Definición de la clase Documento que extiende la clase Conectar */
    ...
    class Documento extends Conectar{
        ...
        /* TODO: Método para registra un nuevo documento en la base de datos */
        ...
        public function registrar_documento($area_id, $tra_id, $doc_externo, $tip_id, $doc_dni, $doc_nom, $doc_descrip, $usu_id){
           ...
           /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
            ...
            $sql="INSERT INTO tm_documento (area_id, tra_id, doc_externo, tip_id, doc_dni, doc_nom, doc_descrip, usu_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        public function insert_documento_detalle($doc_id, $det_nom, $usu_id, $det_tipo){
            ...
            /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
             ...
             $sql="INSERT INTO td_documento_detalle (doc_id, det_nom, usu_id, det_tipo) VALUES (?, ?, ?, ?)";
...
public function actualizar_respuesta_documento($doc_id, $doc_respuesta, $doc_usu_terminado){
 ...
 /*  TODO: Consulta SQL para insertar un nuevo usuario en la tabla tm_usuario */
  ...
  $sql="UPDATE tm_documento SET doc_respuesta = ?, doc_usu_terminado = ?, 
        fech_terminado = NOW(), doc_estado = 'Terminado' 
        WHERE doc_id = ?";
