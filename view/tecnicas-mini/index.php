...
<html lang="es">
    ...
    <head>
     ...
     <link rel="stylesheet" href="../../assets/css/style.css">
        ...
        <title>La Usina Software | Técnicas y Modalidades</title>
    ...
    <!-- <body data-layout="horizontal"> -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Técnicas y Modalidades - Mini Asamblea</h4>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">Listado de Técnicas y Modalidades</h4>
                                        </div>
        ...
        <script type="text/javascript" src="tecnicasmini.js"></script>
