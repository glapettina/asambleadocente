...
function guardaryeditar(e){
    ...
    $.ajax({
        url: "../../controller/vacantes.php?op=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
$(document).ready(function(){
    ...
    tabla = $('#listado_table').dataTable({
        ...
        "ajax":{
            url: '../../controller/vacantes.php?op=listar',
            type: "get",
            dataType: "json",
            error:function(e){
...
function editar(vacante_id){
    ...
    $.post("../../controller/vacantes.php?op=mostrar", {vacante_id : vacante_id}, function(data){
...
function eliminar(vacante_id){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.post("../../controller/vacantes.php?op=eliminar", {vacante_id : vacante_id}, function(data){
                $("#listado_table").DataTable().ajax.reload();
                Swal.fire({ 
                    title: "Asamblea Docente", 
