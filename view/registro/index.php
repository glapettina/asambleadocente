...
<html lang="es">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Registro | La Usina Software - Asamblea Docente</title>
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src="../../assets/picture/logo-sm.svg" alt="" height="28"> <span class="logo-txt">La Usina Software</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        ...
                                        <form id="mnt_form" class="needs-validation custom-form mt-4 pt-2" novalidate="" action="index.html">
                                            <div class="mb-3">
                                                <label for="userusu_correoemail" class="form-label">Correo Electrónico</label>
                                         ...
                                         <div class="mt-4 pt-2 text-center">
                                            <div class="signin-other-title">
                                                <h5 class="font-size-14 mb-3 text-muted fw-medium">- Registrando usando -</h5>
                                            </div>
                                    ...
                                    <div class="mt-4 mt-md-5 text-center" style="margin-top: 1rem !important">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> La Usina Software <i class="mdi mdi-heart text-danger"></i> by Guillermo Lapettina</p>
                                    </div>
                                </div>
                            </div>
                        </div>
