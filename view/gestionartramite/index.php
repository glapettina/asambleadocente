...
<html lang="es">
    ...
    <head>
        ...
        <title>La Usina Software | Gestionar Trámite Mesa de Partes</title>
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Gestionar Trámite</li>
                                        </ol>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                                 ...
                                                 <div class="col-lg-6">
                                                     <div class="mb-3">
                                                       <label for="area_id" class="form-label">Seleccione Area (*)</label>
