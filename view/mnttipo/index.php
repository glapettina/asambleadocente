...
<html lang="es">
    ...
    <head>
        ...
        <title>La Usina Software | Mantenimiento Tipo Mesa de Partes</title>
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Tipo</a></li>
                                            <li class="breadcrumb-item active">Mantenimiento de Tipo</li>
                                        </ol>
                                    </div>
