...
<html lang="es">
    ...
    <!-- <body data-layout="horizontal"> -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Favoritos - Mini Asamblea</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="../home/">Home</a></li>
                                            <li class="breadcrumb-item active">Favoritos - Mini Asamblea</li>
                                        </ol>
                                    </div>
        ...
        <script type="text/javascript" src="favoritosmini.js"></script>
