<?php
    ...
    $rol = new Rol();
    $datos = $rol->validar_menu_x_rol($_SESSION["rol_id"], "mntvacantesmini");
...
<html lang="es">
    ...
    <!-- <body data-layout="horizontal"> -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Vacantes Mini Asamblea</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                            <li class="breadcrumb-item active">Vacantes Mini Asamblea</li>
                                        </ol>
                                    </div>
        ...
        <script type="text/javascript" src="mntvacantesmini.js"></script>
