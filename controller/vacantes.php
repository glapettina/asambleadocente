   ...
   $vacante = new Vacantes();
    ...
    switch ($_GET["op"]) {
        ...
        case 'listarmini':
            ...
            $datos = $vacante->get_vacantes_mini();
            $data = Array();
            foreach ($datos as $row) {
        ...
        case 'guardaryeditarmini':

            $datos = $vacante->get_vacante_id_mini($_POST["esc_id"], $_POST["id"]);


            if (is_array($datos) == true and count($datos) == 0) {
                if (empty($_POST["vacante_id"])) {
                
                    $vacante->insert_vacante_mini($_POST["area_id"], $_POST["esc_id"], 
                    $_POST["codigo"], $_POST["asignatura"],
                    $_POST["id"], $_POST["horas"],
                    $_POST["turno"], $_POST["origen"]);
                    echo "1";
                    ...
                    $vacante->update_vacante_mini($_POST["vacante_id"], $_POST["esc_id"], $_POST["codigo"],
                                            $_POST["asignatura"], $_POST["id"], $_POST["horas"],
                                            $_POST["turno"], $_POST["origen"]);
                    echo "2";
                }         
        ...
        case 'eliminarmini':
            $datos = $vacante->eliminar_vacante_mini($_POST["vacante_id"]);
            echo "1";
        break;
    }
?>